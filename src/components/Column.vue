    ...
    <section class="column">
        <header>
            <div v-if="!edit" class="column-not-edit">
                ...
                <div class="actions">
                    <a href="javascript:;" title="Arquivar" class="archive" @click="clickArquivar">
                        <i class="fas fa-archive"></i>
                    </a>
                    <a href="javascript:;" title="Editar" class="edit" @click="edit = !edit">
            ...
            <div v-else class="column-edit">
                ...
                <input type="text" v-model="titulo" @keyup.enter="clickSalvar" class="form-control" />
                
                <button class="btn btn-success" @click="clickSalvar">
                    Ok
                </button>
            </div>
        </header>
        ...
        methods: {
            ...
            cardSave(card) {
                ...
                if (index >= 0) {
                    ...
                    this.$toast.error('Não foi possível localizar o cartão localmente');
                }
            },
